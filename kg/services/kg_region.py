...
class KgRegion:
    ...
    CN_NORTH_4 = Region(id="cn-north-4",
                        endpoint="https://nlp-ext.cn-north-4.myhuaweicloud.com")
    ...
    @staticmethod
    def value_of(region_id, static_fields=types.MappingProxyType(
        static_fields) if six.PY3 else static_fields):
